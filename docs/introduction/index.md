...
As part of Testnet Phase 3 we have launched the [Super Chat](/developers/marketplace_offers/chat/), a technological demo to showcase how complex dynamic web apps can be run in decentralized confidential environments (TEE).
