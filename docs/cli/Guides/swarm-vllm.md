...
- two scripts: [`deploy_medgemma_official.sh`](/files/deploy_medgemma_official.sh) and [`deploy_apertus_official.sh`](/files/deploy_apertus_official.sh)
...
Replace `<DOMAIN>` with your domain in the following requests.
