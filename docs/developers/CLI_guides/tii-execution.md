...
You might already be aware that you can run your custom solutions on the Super Protocol network. If not, check out the [Execution of python script](/developers/deployment_guides/jobs) guide, which explains how to prepare custom solutions and data.
...
This example builds upon the [Execution of python script](/developers/deployment_guides/jobs) guide. Once you're ready, execute a command:
