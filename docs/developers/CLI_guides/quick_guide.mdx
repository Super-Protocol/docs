...
* `tar.gz` archive - the actual solution content files to be executed inside the TEE;
...
Run the [**files upload**](/developers/cli_commands/files/upload) command using the two files above.
...
Run the [**workflows create**](/developers/cli_commands/workflows/create) command.
