...
* `tar.gz` archive - the solution content files properly packed for execution inside the TEE;
* `metadata.json` file - hashes that might be needed to ensure the integrity of the archive.
