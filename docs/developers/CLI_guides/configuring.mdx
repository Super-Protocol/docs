...
Here is an example (you can copy and paste it or <a target="\_blank" href={require('./assets/config.json').default}>download</a>). Some parameters are pre-configured.
...
Check version, it should be 0.8.2 or greater:
```
./spctl --version
```
