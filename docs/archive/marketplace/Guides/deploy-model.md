...
To deploy your model, you need to create a new <a id="offer"><span className="dashed-underline">offer</span></a> and upload model files. The offer will remain private and unavailable to other users until you [publish it](/archive/marketplace/guides/publish-offer).
...
<img src={require('../images/offer-builder-category-engine.png').default} width="auto" height="auto" border="1"/>
<br/>
<br/>

2.4. Open the **Content** tab and click **Upload Content**.

<img src={require('../images/offer-builder-upload-content.png').default} width="auto" height="auto" border="1"/>
<br/>
<br/>
...
<img src={require('../images/offer-builder-deploy.png').default} width="auto" height="auto" border="1"/>
<br/>
<br/>
