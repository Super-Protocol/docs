...
slug: "/marketplace/guides/storage"
sidebar_position: 6
---

This guide provides step-by-step instructions on how to set up your personal Storj account.

The guide is intended for advanced users; feel free to skip it and continue using the default recommended option—**Super Protocol cloud**. Read about [types of storage](/archive/marketplace/account#storage).
