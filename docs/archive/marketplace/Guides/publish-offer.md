...
slug: "/marketplace/guides/publish-offer"
sidebar_position: 4
---
...
Follow the [Deploy Your Model](/archive/marketplace/guides/deploy-model) guide and verify that your model runs successfully.
