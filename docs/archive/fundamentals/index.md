...
Customers place <a id="order"><span className="dashed-underline">orders</span></a> by adding offers and paying for them according to the prices set by the providers of these offers. To learn more about orders, order statuses, pricing, and possible usage scenarios, refer to the [documentation](/archive/fundamentals/orders).
