...
| `--use-addon`                             | Flag for uploading a directory instead of a single TAR.GZ archive. <br/>To manage the data uploaded this way, use this option with the [`files delete`](/archive/cli/commands/files/delete) and [`files download`](/archive/cli/commands/files/download) commands. |
