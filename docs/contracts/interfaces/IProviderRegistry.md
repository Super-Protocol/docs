---
id: "IProviderRegistry"
title: "IProviderRegistry"
sidebar_label: "IProviderRegistry"
sidebar_position: 0
---
...
[IProviderRegistry-checkRegistration-address-]: #IProviderRegistry-checkRegistration-address-
[IProviderRegistry-getSecurityDeposit-address-]: #IProviderRegistry-getSecurityDeposit-address-
[IProviderRegistry-get-address-]: #IProviderRegistry-get-address-
[IProviderRegistry-hasEnoughSecurityDeposit-address-]: #IProviderRegistry-hasEnoughSecurityDeposit-address-
[IProviderRegistry-chargePenalty-address-uint256-]: #IProviderRegistry-chargePenalty-address-uint256-
...
```solidity
  function get(
  ) external returns (address providerInfoContract)
```
