...
[IValueOffer]: #IValueOffer
[IValueOffer-getProviderAuthority--]: #IValueOffer-getProviderAuthority--
[IValueOffer-getInfo--]: #IValueOffer-getInfo--
[IValueOffer-setName-string-]: #IValueOffer-setName-string-
[IValueOffer-setDescription-string-]: #IValueOffer-setDescription-string-
[IValueOffer-enable--]: #IValueOffer-enable--
[IValueOffer-disable--]: #IValueOffer-disable--
...
```solidity
  function getInfo(
  ) external returns (struct OfferInfo)
```
