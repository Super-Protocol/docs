...
[ISuperpro]: #ISuperpro
[ISuperpro-getLatestSuperpro--]: #ISuperpro-getLatestSuperpro--
[ISuperpro-getNameByAddress-address-]: #ISuperpro-getNameByAddress-address-
[ISuperpro-getAddress-enum-ContractName-]: #ISuperpro-getAddress-enum-ContractName-
[ISuperpro-setAddress-enum-ContractName-address-]: #ISuperpro-setAddress-enum-ContractName-address-
[ISuperpro-setParam-enum-ParamName-uint256-]: #ISuperpro-setParam-enum-ParamName-uint256-
[ISuperpro-getParam-enum-ParamName-]: #ISuperpro-getParam-enum-ParamName-
...
```solidity
  ...
  ) external returns (enum ContractName)
```
