...
[ITeeOffer]: #ITeeOffer
[ITeeOffer-addTcb-address-]: #ITeeOffer-addTcb-address-
[ITeeOffer-lock-address-uint256-]: #ITeeOffer-lock-address-uint256-
[ITeeOffer-unlock-address-uint256-]: #ITeeOffer-unlock-address-uint256-
[ITeeOffer-blockOffer--]: #ITeeOffer-blockOffer--
[ITeeOffer-incrViolationRate--]: #ITeeOffer-incrViolationRate--
[ITeeOffer-enable--]: #ITeeOffer-enable--
[ITeeOffer-disable--]: #ITeeOffer-disable--
[ITeeOffer-get--]: #ITeeOffer-get--
[ITeeOffer-getInfo--]: #ITeeOffer-getInfo--
[ITeeOffer-getLastTcbReward--]: #ITeeOffer-getLastTcbReward--
[ITeeOffer-getTcb--]: #ITeeOffer-getTcb--
[ITeeOffer-hasTcb-address-]: #ITeeOffer-hasTcb-address-
[ITeeOffer-getTotalLocked--]: #ITeeOffer-getTotalLocked--
[ITeeOffer-getViolationRate--]: #ITeeOffer-getViolationRate--
[ITeeOffer-getLockInfo-address-]: #ITeeOffer-getLockInfo-address-
...
```solidity
  function getInfo(
  ) external returns (struct TeeOfferInfo)
```
