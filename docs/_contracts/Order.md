...
[Order]: #Order
[Order-onlyProviderActionAccount--]: #Order-onlyProviderActionAccount--
[Order-onlyConsumer--]: #Order-onlyConsumer--
[Order-parentOrder-address]: #Order-parentOrder-address
[Order-consumer-address]: #Order-consumer-address
[Order-startDate-uint256]: #Order-startDate-uint256
[Order-subOrders-address--]: #Order-subOrders-address--
[Order-externalId-bytes32]: #Order-externalId-bytes32
[Order-orderInfo-struct-OrderInfo]: #Order-orderInfo-struct-OrderInfo
[Order-orderResult-struct-OrderResult]: #Order-orderResult-struct-OrderResult
[Order-offerType-enum-OfferType]: #Order-offerType-enum-OfferType
[Order-origins-struct-Origins]: #Order-origins-struct-Origins
[Order-superpro-contract-ISuperpro]: #Order-superpro-contract-ISuperpro
[Order-changeWithdrawn-bool]: #Order-changeWithdrawn-bool
[Order-profitWithdrawn-bool]: #Order-profitWithdrawn-bool
[Order-suborderGroupCount-mapping-enum-OfferGroup----uint256-]: #Order-suborderGroupCount-mapping-enum-OfferGroup----uint256-
[Order-inputOffersTypesCount-mapping-enum-OfferType----uint256-]: #Order-inputOffersTypesCount-mapping-enum-OfferType----uint256-
[Order-constructor-address-address-address-struct-OrderInfo-uint256-bool-bytes32-]: #Order-constructor-address-address-address-struct-OrderInfo-uint256-bool-bytes32-
[Order-getOrigins--]: #Order-getOrigins--
[Order-start--]: #Order-start--
[Order-updateStatusFromSuborders-address-enum-OrderStatus-]: #Order-updateStatusFromSuborders-address-enum-OrderStatus-
[Order-complete-enum-OrderStatus-string-string-]: #Order-complete-enum-OrderStatus-string-string-
[Order-cancelOrder--]: #Order-cancelOrder--
[Order-isCompleted--]: #Order-isCompleted--
[Order-isReadyForProcessing--]: #Order-isReadyForProcessing--
[Order-setProcessingStatus--]: #Order-setProcessingStatus--
[Order-updateStatus-enum-OrderStatus-uint256-]: #Order-updateStatus-enum-OrderStatus-uint256-
[Order-getOrderInfo--]: #Order-getOrderInfo--
[Order-getOrderResult--]: #Order-getOrderResult--
[Order-getSubOrders--]: #Order-getSubOrders--
[Order-getChangeWithdrawn--]: #Order-getChangeWithdrawn--
[Order-getProfitWithdrawn--]: #Order-getProfitWithdrawn--
[Order-getConsumer--]: #Order-getConsumer--
[Order-getOrderPrice--]: #Order-getOrderPrice--
[Order-getParentOrder--]: #Order-getParentOrder--
[Order-createSubOrder-struct-OrderInfo-bool-bytes32-]: #Order-createSubOrder-struct-OrderInfo-bool-bytes32-
[Order-withdrawProfit--]: #Order-withdrawProfit--
[Order-withdrawChange--]: #Order-withdrawChange--
[Order-getExteranlId--]: #Order-getExteranlId--
[Order-OrderStatusUpdated-address-enum-OrderStatus-]: #Order-OrderStatusUpdated-address-enum-OrderStatus-
[Order-SubOrderCreated-address-]: #Order-SubOrderCreated-address-
