...
[Config]: #Config
[Config-getUpdParam-contract-ISuperpro-enum-ParamName-]: #Config-getUpdParam-contract-ISuperpro-enum-ParamName-
[Config-getOrdersFactory-contract-ISuperpro-]: #Config-getOrdersFactory-contract-ISuperpro-
[Config-getTeeFactory-contract-ISuperpro-]: #Config-getTeeFactory-contract-ISuperpro-
[Config-getValueFactory-contract-ISuperpro-]: #Config-getValueFactory-contract-ISuperpro-
[Config-getProviders-contract-ISuperpro-]: #Config-getProviders-contract-ISuperpro-
[Config-getStaking-contract-ISuperpro-]: #Config-getStaking-contract-ISuperpro-
[Config-getToken-contract-ISuperpro-]: #Config-getToken-contract-ISuperpro-
[Config-getTokenFull-contract-ISuperpro-]: #Config-getTokenFull-contract-ISuperpro-
[Config-getEpochs-contract-ISuperpro-]: #Config-getEpochs-contract-ISuperpro-
[Config-getLastBlocks-contract-ISuperpro-]: #Config-getLastBlocks-contract-ISuperpro-
[Config-getSuspicious-contract-ISuperpro-]: #Config-getSuspicious-contract-ISuperpro-
[Config-getConsensus-contract-ISuperpro-]: #Config-getConsensus-contract-ISuperpro-
...
### getOrdersFactory
```solidity
  function getOrdersFactory(
  ) internal returns (contract IOrdersFactory)
```
...
### getTeeFactory
```solidity
  function getTeeFactory(
  ) internal returns (contract ITeeOffersFactory)
```
...
```solidity
  ...
  ) internal returns (contract IValueOffersFactory)
```
...
```solidity
  ...
  ) internal returns (contract IProviderRegistry)
```
...
```solidity
  ...
  ) internal returns (contract SuperproToken)
```
...
```solidity
  function getEpochs(
  ) internal returns (contract IEpochs)
```
...
```solidity
  ...
  ) internal returns (contract ILastBlocks)
```
...
```solidity
  ...
  ) internal returns (contract ISuspicious)
```
...
```solidity
  ...
  ) internal returns (contract IConsensus)
```
