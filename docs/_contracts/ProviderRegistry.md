...
[ProviderRegistry-onlyNotRegistred--]: #ProviderRegistry-onlyNotRegistred--
[ProviderRegistry-onlyConsensus--]: #ProviderRegistry-onlyConsensus--
[ProviderRegistry-superpro-contract-ISuperpro]: #ProviderRegistry-superpro-contract-ISuperpro
[ProviderRegistry-providersInfo-mapping-address----address-]: #ProviderRegistry-providersInfo-mapping-address----address-
[ProviderRegistry-providersInfoList-address--]: #ProviderRegistry-providersInfoList-address--
[ProviderRegistry-constructor-address-]: #ProviderRegistry-constructor-address-
[ProviderRegistry-register-struct-ProviderInfo-bytes32-]: #ProviderRegistry-register-struct-ProviderInfo-bytes32-
[ProviderRegistry-get-address-]: #ProviderRegistry-get-address-
[ProviderRegistry-refillSecurityDepo-uint256-]: #ProviderRegistry-refillSecurityDepo-uint256-
[ProviderRegistry-returnSecurityDepo-uint256-]: #ProviderRegistry-returnSecurityDepo-uint256-
[ProviderRegistry-listAll--]: #ProviderRegistry-listAll--
[ProviderRegistry-checkRegistration-address-]: #ProviderRegistry-checkRegistration-address-
[ProviderRegistry-hasEnoughSecurityDeposit-address-]: #ProviderRegistry-hasEnoughSecurityDeposit-address-
[ProviderRegistry-chargePenalty-address-uint256-]: #ProviderRegistry-chargePenalty-address-uint256-
[ProviderRegistry-getSecurityDeposit-address-]: #ProviderRegistry-getSecurityDeposit-address-
[ProviderRegistry-ProviderRegistred-address-]: #ProviderRegistry-ProviderRegistred-address-
...
```solidity
  function get(
  ) public returns (address providerInfoContract)
```
...
### hasEnoughSecurityDeposit
```solidity
  function hasEnoughSecurityDeposit(
  ) public returns (bool)
```
